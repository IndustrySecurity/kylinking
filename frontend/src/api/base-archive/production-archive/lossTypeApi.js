...
export const getLossTypes = (params) => {
  return request({
    url: '/tenant/base-archive/production-archive/loss-types/',
    method: 'get',
    params
  });
};
...
export const getEnabledLossTypes = () => {
  return request({
    url: '/tenant/base-archive/production-archive/loss-types/enabled',
    method: 'get'
  });
};
...
export const getLossType = (id) => {
  return request({
    url: `/tenant/base-archive/production-archive/loss-types/${id}`,
    method: 'get'
  });
};
...
export const batchUpdateLossTypes = (data) => {
  return request({
    url: '/tenant/base-archive/production-archive/loss-types/batch',
    method: 'put',
    data
  });
};
