...
import { customerCategoryApi } from '../../api/customerCategory';
...
const CustomerCategoryManagement = () => {
  ...
  const loadData = async (params = {}) => {
    ...
    try {
      ...
      const { customer_categories, total, current_page } = response;
  ...
  const handleDelete = async (key) => {
    try {
      ...
      if (record.id && !record.id.startsWith('temp_')) {
        // 删除服务器记录
        await customerCategoryApi.deleteCustomerCategory(record.id);
