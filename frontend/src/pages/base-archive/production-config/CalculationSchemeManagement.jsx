...
import { calculationSchemeApi } from '../../../api/base-archive/production-config/calculationScheme';
import { calculationParameterApi } from '../../../api/base-archive/production-config/calculationParameter';
  ...
  const loadOptions = async () => {
    try {
      ...
      if (categoriesResponse.data.success) {
        setSchemeCategories(categoriesResponse.data.data || []);
      }
